const enUS = {
  ...
  chat: {
    ...
    sources: 'Sources',
    saveAsNote: 'Worth keeping? Save this as a note',
    saveToNotes: 'Save as note',
    savedToNotes: 'Saved',
  ...
  about: {
    title: 'About',
    description: '云笔迹 is an intelligent note-taking and knowledge management platform that leverages AI capabilities to help you better record, organize, and review knowledge.',
